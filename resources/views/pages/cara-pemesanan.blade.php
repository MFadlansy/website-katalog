...
@section('content')
<section class="bg-[#f7f3ef] pt-32 pb-28">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="text-center mb-20">
            ...
            <p class="text-[#5c5347] max-w-2xl mx-auto font-light leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            {{-- Step 1 --}}
            <div class="bg-[#fbf9f6] rounded-3xl shadow-md hover:shadow-xl transition p-10 text-center space-y-6">
                <div class="w-14 h-14 mx-auto flex items-center justify-center border border-[#2a241b] text-[#2a241b] rounded-full font-semibold text-lg">
                    01
                </div>
                <h3 class="font-serif text-xl tracking-wide text-[#2a241b]">
                    Pilih Produk
                </h3>
                <p class="text-[#5c5347] text-sm leading-relaxed">
